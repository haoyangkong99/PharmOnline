...
public class Product {
    String ID, name, description,category,image;
    double price;
    int quantity;
    ...
    public void setPrice(double price) {
     ...
     public void insertIntoDB() throws ClassNotFoundException, SQLException{
        ...
        String pw = "";
        String query = "INSERT INTO `pharmonline`.`product`(`product_ID`, `product_Name`, `product_Description`, `product_Selling_Price`,`product_Category`,`product_Quantity`) VALUES ('"+ ID +"', '"+ name +"', '"+ description +"','"+ price +"','"+ category +"','"+ quantity +"')";
